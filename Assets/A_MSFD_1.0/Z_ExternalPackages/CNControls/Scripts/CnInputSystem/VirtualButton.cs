	...
	namespace CnControls
	{
		...
		public class VirtualButton
		{
			...
			public void Press()
			{
				...
				IsPressed = true;
                _lastPressedFrame = UnityEngine.Time.frameCount;
			}
			...
			{
				IsPressed = false;
                _lastReleasedFrame = UnityEngine.Time.frameCount;
			}
			...
			public bool GetButtonDown
			{
				get
				{
					return _lastPressedFrame != -1 && _lastPressedFrame - UnityEngine.Time.frameCount == -1;
				}
			}
			...
			public bool GetButtonUp
			{
				get
				{
					return _lastReleasedFrame != -1 && _lastReleasedFrame == UnityEngine.Time.frameCount - 1;
				}
			}
		}
	}
