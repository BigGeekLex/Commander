    ...
    namespace CnControls
    {
        public class Touchpad : MonoBehaviour, IDragHandler, IPointerUpHandler, IPointerDownHandler
        {
            ...
            public virtual void OnDrag(PointerEventData eventData)
            {
                ...
                _lastDragFrameNumber = UnityEngine.Time.renderedFrameCount;
            }
            ...
            private void Update()
            {
                if (_isCurrentlyTweaking && _lastDragFrameNumber < UnityEngine.Time.renderedFrameCount - 2)
                {
                    _horizintalAxis.Value = 0f;
                    _verticalAxis.Value = 0f;
                }
                ...
                {
                    _horizintalAxis.Value = Mathf.Lerp(_horizintalAxis.Value, 0f, Friction * UnityEngine.Time.deltaTime);
                    _verticalAxis.Value = Mathf.Lerp(_verticalAxis.Value, 0f, Friction * UnityEngine.Time.deltaTime);
                }
            }
        }
    }
